...
Private Sub Command4_Click()
    ...
    If General_File_Exists(CurStreamFile, vbNormal) = True Then
        retval = MsgBox("¡El archivo " & CurStreamFile & " ya existe!" & vbCrLf & _
                "¿Deseas sobreescribirlo?", vbYesNoCancel Or vbQuestion)
    ...
    If Bypass = False Then
        ...
        If General_File_Exists(StreamFile, vbNormal) = True Then
            retval = MsgBox("¡El archivo " & StreamFile & " ya existe!" & vbCrLf & _
                    "¿Desea sobreescribirlo?", vbYesNo Or vbQuestion)
    ...
    For loopc = 1 To TotalStreams
        ...
        General_Var_Write StreamFile, Val(loopc), "ColorSet1", StreamData(loopc).colortint(0).r & "," & _
                StreamData(loopc).colortint(0).g & "," & StreamData(loopc).colortint(0).B
        General_Var_Write StreamFile, Val(loopc), "ColorSet2", StreamData(loopc).colortint(1).r & "," & _
                StreamData(loopc).colortint(1).g & "," & StreamData(loopc).colortint(1).B
        General_Var_Write StreamFile, Val(loopc), "ColorSet3", StreamData(loopc).colortint(2).r & "," & _
                StreamData(loopc).colortint(2).g & "," & StreamData(loopc).colortint(2).B
        General_Var_Write StreamFile, Val(loopc), "ColorSet4", StreamData(loopc).colortint(3).r & "," & _
                StreamData(loopc).colortint(3).g & "," & StreamData(loopc).colortint(3).B
...
Private Sub Command5_Click()
    ...
    ReDim StreamData(NewStreamNumber).grh_list(1 To 1)
    StreamData(NewStreamNumber).grh_list(1) = 1
...
Sub CargarParticulasLista()
    ...
    General_Particle_Create (frmMain.List2.ListIndex + 1), 50, 50
