    ...
    For y = YMinMapSize To YMaxMapSize
        For X = XMinMapSize To XMaxMapSize
            ...
            If MapData(X, y).Graphic(1).GrhIndex <> 0 Then
                Call DDrawGrhtoSurface(renderSurface, MapData(X, y).Graphic(1), (X - 1) * TilePixelWidth, (y - 1) * _
                        TilePixelHeight, 0, 1)
    ...
    For y = YMinMapSize To YMaxMapSize
        For X = XMinMapSize To XMaxMapSize
            ...
            If (MapData(X, y).Graphic(2).GrhIndex <> 0) And bVerCapa(2) Then
                Call DDrawTransGrhtoSurface(renderSurface, MapData(X, y).Graphic(2), (X - 1) * TilePixelWidth, (y - _
                        1) * TilePixelHeight, 1, 1)
        ...
        For X = XMinMapSize To XMaxMapSize
            ...
            With MapData(X, y)
                ...
                If (.ObjGrh.GrhIndex <> 0) And bVerObjetos Then
                    Call DDrawTransGrhtoSurface(renderSurface, .ObjGrh, PixelOffsetXTemp, PixelOffsetYTemp, 1, 1)
                ...
                If (.Graphic(3).GrhIndex <> 0) And bVerCapa(3) Then
                    'Draw
                    Call DDrawTransGrhtoSurface(renderSurface, .Graphic(3), PixelOffsetXTemp, PixelOffsetYTemp, 1, 1)
        ...
        For X = XMinMapSize To XMaxMapSize
            ...
            With MapData(X, y)
                ...
                If (.Graphic(4).GrhIndex <> 0) And bVerCapa(4) Then
                    'Draw
                    Call DDrawTransGrhtoSurface(renderSurface, .Graphic(4), (X - 1) * TilePixelWidth, (y - 1) * _
                            TilePixelHeight, 1, 1)
        ...
        For X = XMinMapSize To XMaxMapSize
            ...
            With MapData(X, y)
                ...
                If (.TileExit.Map <> 0) And bTranslados Then
                    ...
                    Call DDrawTransGrhtoSurface(renderSurface, Grh, PixelOffsetXTemp, PixelOffsetYTemp, 1, 0)
