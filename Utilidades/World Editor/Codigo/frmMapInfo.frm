...
Begin VB.Form frmMapInfo 
   ...
   Begin VB.CheckBox chkInvisibilidad 
      ...
      Width           =   2055
   End
   Begin VB.CheckBox chkResucitar 
   ...
   Begin VB.CheckBox chkInvocar 
      ...
      Width           =   1815
   End
   Begin VB.CheckBox chkRoboDeNpc 
...
Private Sub chkInvisibilidad_Click()
    MapInfo.InviSinEfecto = chkInvisibilidad.Value
    MapInfo.Changed = 1
...
Private Sub chkResucitar_Click()
    MapInfo.ResuSinEfecto = chkResucitar.Value
    MapInfo.Changed = 1

End Sub

Private Sub chkRoboDeNpc_LostFocus()
    MapInfo.RoboNpcsPermitido = chkRoboDeNpc.Value
    MapInfo.Changed = 1
...
Private Sub txtX_Change()
    MapInfo.OnDeathGoTo.X = Val(txtX.Text)
    MapInfo.Changed = 1

End Sub

Private Sub txtY_Change()
    MapInfo.OnDeathGoTo.y = Val(txtY.Text)
    MapInfo.Changed = 1

End Sub

Private Sub txtMap_Change()
    MapInfo.OnDeathGoTo.Map = Val(txtMap.Text)
    MapInfo.Changed = 1
