...
Public Const MSGMod          As String = "Este mapa há sido modificado." & vbCrLf & _
        "Si no lo guardas perderas todos los cambios ¿Deseas guardarlo?"
Public Const MSGDang         As String = "CUIDADO! Este comando puede arruinar el mapa." & vbCrLf & _
