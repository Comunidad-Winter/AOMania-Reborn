...
Public Sub Main()
    ...
    If FileExist(IniPath & "WorldEditor.jpg", vbArchive) Then frmCargando.Picture1.Picture = LoadPicture(IniPath & _
            "WorldEditor.jpg")
    ...
    If InitTileEngine(frmMain.hwnd, frmMain.MainViewShp.Top + 50, frmMain.MainViewShp.Left + 4, 32, 32, PantallaY, _
            PantallaX, 9, 8, 8, 0.018) Then ' 30/05/2006
...
Public Function GetVar(ByRef file As String, _
                       ByRef Main As String, _
                       ByRef Var As String) As String
    '*************************************************
    'Author: Unkwown
    'Last modified: 20/05/06
    '*************************************************
...
Public Sub WriteVar(ByRef file As String, _
                    ByRef Main As String, _
...
Public Sub FixCoasts(ByVal GrhIndex As Integer, ByVal X As Integer, ByVal y As Integer)
    ...
    If GrhIndex = 7284 Or GrhIndex = 7290 Or GrhIndex = 7291 Or GrhIndex = 7297 Or GrhIndex = 7300 Or GrhIndex = 7301 _
            Or GrhIndex = 7302 Or GrhIndex = 7303 Or GrhIndex = 7304 Or GrhIndex = 7306 Or GrhIndex = 7308 Or _
            GrhIndex = 7310 Or GrhIndex = 7311 Or GrhIndex = 7313 Or GrhIndex = 7314 Or GrhIndex = 7315 Or GrhIndex = _
            7316 Or GrhIndex = 7317 Or GrhIndex = 7319 Or GrhIndex = 7321 Or GrhIndex = 7325 Or GrhIndex = 7326 Or _
            GrhIndex = 7327 Or GrhIndex = 7328 Or GrhIndex = 7332 Or GrhIndex = 7338 Or GrhIndex = 7339 Or GrhIndex = _
            7345 Or GrhIndex = 7348 Or GrhIndex = 7349 Or GrhIndex = 7350 Or GrhIndex = 7351 Or GrhIndex = 7352 Or _
            GrhIndex = 7349 Or GrhIndex = 7350 Or GrhIndex = 7351 Or GrhIndex = 7354 Or GrhIndex = 7357 Or GrhIndex = _
            7358 Or GrhIndex = 7360 Or GrhIndex = 7362 Or GrhIndex = 7363 Or GrhIndex = 7365 Or GrhIndex = 7366 Or _
            GrhIndex = 7367 Or GrhIndex = 7368 Or GrhIndex = 7369 Or GrhIndex = 7371 Or GrhIndex = 7373 Or GrhIndex = _
            7375 Or GrhIndex = 7376 Then MapData(X, y).Graphic(2).GrhIndex = 0
    ...
    For loopc = 1 To LastChar
        ...
        If CharList(loopc).Active = 1 Then
            ...
            If CharList(loopc).Heading <> 0 Then
                ...
                frmMain.picRadar.Line (0 + CharList(loopc).Pos.X, 0 + CharList(loopc).Pos.y)-(2 + CharList( _
                        loopc).Pos.X, 0 + CharList(loopc).Pos.y)
                frmMain.picRadar.Line (0 + CharList(loopc).Pos.X, 1 + CharList(loopc).Pos.y)-(2 + CharList( _
                        loopc).Pos.X, 1 + CharList(loopc).Pos.y)
...
Public Sub CaptionWorldEditor(ByVal Trabajando As String, ByVal Editado As Boolean)
    ...
    frmMain.Caption = "WorldEditor v" & App.Major & "." & App.Minor & " Build " & App.Revision & " - [" & Trabajando _
            & "]"
