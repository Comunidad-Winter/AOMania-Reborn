    ...
    For y = YMinMapSize To YMaxMapSize
        For X = XMinMapSize To XMaxMapSize
            ...
            With MapData(X, y)
                ...
                If (X < MinXBorder Or X > MaxXBorder Or y < MinYBorder Or y > MaxYBorder) And ( _
                        chkQuitarTodoBordes.Value = 1) Then
                ...
                ' ** Mapea Arboles, Carteles, Foros y Yacimientos que no esten en la 3ra Capa
                If (.OBJInfo.objindex > 0) And ((chkMapearArbolesEtc.Value = 1) Or (chkBloquearArbolesEtc.Value = 1)) _
                        Then
                    ...
                    Select Case ObjData(.OBJInfo.objindex).ObjType
                        ...
                        Case 4, 8, 10, 22 ' Arboles, Carteles, Foros, Yacimientos
                            ...
                            If (.Graphic(3).GrhIndex <> .ObjGrh.GrhIndex) And (chkMapearArbolesEtc.Value = 1) Then _
                                    .Graphic(3) = .ObjGrh
