...
Private Sub Command1_Click()
    ...
    For ii = 1 To 6
        ...
        If Val(FormAuto.TextDatos(ii).Text) > grhCount Or Val(FormAuto.TextDatos(ii).Text) <= 0 Then
    ...
    If (Not hayGrHlibres(PrimerIndice, FramesTotales + 1)) Or PrimerIndice <= 0 Or PrimerIndice > grhCount Then
    ...
    If Option1(0).value Then
        ...
        ReDim GrhData(PrimerIndice + ActualFrame).Frames(1 To 1) As Long
            For FramesX = 1 To FramesAncho
                ...
                GrhData(PrimerIndice + ActualFrame).TileHeight = GrhData(PrimerIndice + _
                        ActualFrame).pixelHeight / TilePixelHeight
                GrhData(PrimerIndice + ActualFrame).TileWidth = GrhData(PrimerIndice + _
                        ActualFrame).pixelWidth / TilePixelWidth
                curX = curX + 1
    ...
    Else
        ...
        ReDim GrhData(PrimerIndice + ActualFrame).Frames(1 To 1) As Long
            ...
            GrhData(PrimerIndice + ActualFrame).TileHeight = GrhData(PrimerIndice + _
                    ActualFrame).pixelHeight / TilePixelHeight
            GrhData(PrimerIndice + ActualFrame).TileWidth = GrhData(PrimerIndice + ActualFrame).pixelWidth _
                    / TilePixelWidth
            ActualFrame = ActualFrame + 1
...
TerminarAnim:
    ...
    ReDim GrhData(PrimerIndice + FramesTotales).Frames(1 To FramesTotales) As Long
...
Private Sub Command2_Click()
    ...
    Dim FramesTotales As Long
    Dim FramesAncho   As Long, FramesAlto As Long
    Dim NumeroBMP     As Long, PrimerIndice As Long
    Dim existenciaBMP As Long
    Dim Alto          As Long, Ancho As Long
    Dim AltoBMP       As Long, AnchoBMP As Long
    Dim BitCount      As Integer
    Dim ii            As Integer
    ...
    For ii = 1 To 6
        ...
        If Val(FormAuto.TextDatos2(ii).Text) > 65000 Or Val(FormAuto.TextDatos2(ii).Text) <= 0 Then
    ...
    If (Not hayGrHlibres(PrimerIndice, FramesTotales + 4)) Or PrimerIndice <= 0 Or PrimerIndice > grhCount _
            Then
        MsgBox "No hay sitio para la animacion" & vbCrLf & "Sobreescribir x implementar"
    ...
    If CheckAuto.value = vbChecked Then
        ...
        If errorEnIndice() Then
            respuesta = MsgBox( _
                    "El grafico Indice de autoindexacion indicado ya existe, ¿estas seguro de sobreescribirlo?", _
                    4, "Aviso")
        Else
            respuesta = vbYes
    ...
    If ComboTipoAnim.listIndex = 0 Then
        If Optiondimension(0).value Then
            ...
            For FramesY = 1 To FramesTotales
                ...
                ReDim Preserve GrhData(PrimerIndice + FramesY - 1).Frames(1 To 1)
                ...
                GrhData(PrimerIndice + FramesY - 1).TileHeight = GrhData(PrimerIndice + FramesY - _
                        1).pixelHeight / TilePixelHeight
                GrhData(PrimerIndice + FramesY - 1).TileWidth = GrhData(PrimerIndice + FramesY - _
                        1).pixelWidth / TilePixelWidth
            Next FramesY
        ...
        ElseIf Optiondimension(1).value Then
            ...
            For FramesY = 1 To 4
                For FramesX = 1 To FramesAncho
                    GrhData(PrimerIndice + ActualFrame).FileNum = NumeroBMP
                    ReDim Preserve GrhData(PrimerIndice + ActualFrame).Frames(1 To 1)
                    GrhData(PrimerIndice + ActualFrame).Frames(1) = PrimerIndice + ActualFrame
                    GrhData(PrimerIndice + ActualFrame).NumFrames = 1
                    GrhData(PrimerIndice + ActualFrame).pixelHeight = Alto
                    GrhData(PrimerIndice + ActualFrame).pixelWidth = Ancho
...
TerminarAnim:
    ...
    If ComboTipoAnim.listIndex = 0 Then
        If Optiondimension(0).value Then 'indexacion clasica de bodys
            ...
            GrhData(PrimerIndice + FramesTotales).Speed = 1
            ReDim Preserve GrhData(PrimerIndice + FramesTotales).Frames(1 To 6)
            ...
            ReDim Preserve GrhData(PrimerIndice + FramesTotales + 1).Frames(1 To 6)
            ...
            ReDim Preserve GrhData(PrimerIndice + FramesTotales + 2).Frames(1 To 5)
            ...
            ReDim Preserve GrhData(PrimerIndice + FramesTotales + 3).Frames(1 To 5)
        ...
        ElseIf Optiondimension(1).value Then 'indexacion npc standar
            ...
            GrhData(PrimerIndice + FramesTotales).Speed = 1
            ReDim Preserve GrhData(PrimerIndice + FramesTotales).Frames(1 To FramesAncho)
            ...
            GrhData(PrimerIndice + FramesTotales + 1).Speed = 1
            ReDim Preserve GrhData(PrimerIndice + FramesTotales + 1).Frames(1 To FramesAncho)
            ...
            GrhData(PrimerIndice + FramesTotales + 2).Speed = 1
            ReDim Preserve GrhData(PrimerIndice + FramesTotales + 2).Frames(1 To FramesAncho)
 
            For ii = (FramesAncho * 2) + 1 To FramesAncho * 3
                GrhData(PrimerIndice + FramesTotales + 2).Frames(ii - (FramesAncho * 2)) = PrimerIndice + _
                        ii - 1
            Next ii
            ...
            GrhData(PrimerIndice + FramesTotales + 3).Speed = 1
            ReDim Preserve GrhData(PrimerIndice + FramesTotales + 3).Frames(1 To FramesAncho)
 
            For ii = (FramesAncho * 3) + 1 To FramesAncho * 4
                GrhData(PrimerIndice + FramesTotales + 3).Frames(ii - (FramesAncho * 3)) = PrimerIndice + _
                        ii - 1
            Next ii
    ...
    ElseIf ComboTipoAnim.listIndex = 1 Then ' animacion con offset
        GrhData(PrimerIndice + FramesTotales).FileNum = NumeroBMP
        GrhData(PrimerIndice + FramesTotales).NumFrames = FramesTotales
        ReDim Preserve GrhData(PrimerIndice + FramesTotales).Frames(1 To FramesTotales)
        GrhData(PrimerIndice + FramesTotales).pixelHeight = GrhData(PrimerIndice).pixelHeight
        GrhData(PrimerIndice + FramesTotales).pixelWidth = GrhData(PrimerIndice).pixelWidth
        GrhData(PrimerIndice + FramesTotales).sX = GrhData(PrimerIndice).sX
        GrhData(PrimerIndice + FramesTotales).sY = GrhData(PrimerIndice).sY
...
Private Sub Command6_Click()
    ...
    For ii = 4 To 5
        ...
        If Val(FormAuto.TextDatos3(ii).Text) > grhCount Or Val(FormAuto.TextDatos3(ii).Text) <= 0 Then
    ...
    If (Not hayGrHlibres(PrimerIndice, 1)) Or PrimerIndice <= 0 Or PrimerIndice > grhCount Then
        respuesta = MsgBox( _
                "El grafico Indice de autoindexacion indicado ya existe, ¿estas seguro de sobreescribirlo?", _
                4, "Aviso")
    ...
    If existenciaBMP > 0 Then
        ...
        ReDim Preserve GrhData(PrimerIndice).Frames(1 To 1)
...
Private Sub TextDatos_Change(Index As Integer)
    ...
    If existenciaBMP > 0 Then
        ...
        If EstadoIndexador <> e_EstadoIndexador.Resource Then Call frmMain.CambiarEstado( _
                e_EstadoIndexador.Resource)
