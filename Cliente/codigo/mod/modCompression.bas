...
ErrHandler:
    ...
    Call LogError("Error al intentar leer el archivo " & ResourceFilePath & ". Razón: " & Err.Number & " : " & Err.Description)
...
ErrHandler:
    Call LogError("Error al intentar decodificar recursos. Razon: " & Err.Number & " : " & Err.Description)
...
Public Function Get_File_Data(ByRef ResourcePath As String, ByRef FileName As String, ByRef Data() As Byte, ByRef NameFile As String) As Boolean
    ...
    Else
        Call LogError("No se encontro el recurso " & FileName)
