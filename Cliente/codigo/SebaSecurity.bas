...
Public Function mpModExp(strBaseHex As String, _
                         strExponentHex As String, _
                         strModulusHex As String) As String
...
Private Function aModExp(abBase() As Byte, _
                         abExponent() As Byte, _
                         abModulus() As Byte, _
                         nLen As Integer) As Variant
...
Private Function aModMult(abX() As Byte, _
                          abY() As Byte, _
                          abMod() As Byte, _
                          nLen As Integer) As Variant
    ' Returns w = (x * y) mod m
