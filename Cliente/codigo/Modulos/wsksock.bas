...
Public Declare Function getsockopt Lib "ws2_32.DLL" (ByVal s As Integer, _
...
Public Declare Function recvfrom Lib "ws2_32.DLL" (ByVal s As Integer, _
    buf As Any, _
    ByVal buflen As Integer, _
    ByVal flags As Integer, _
    from As sockaddr, _
    fromlen As Integer) As Integer
Public Declare Function ws_select Lib "ws2_32.DLL" Alias "select" (ByVal nfds As Integer, _
    readfds As Any, _
    writefds As Any, _
    exceptfds As Any, _
...
Public Declare Function sendto Lib "ws2_32.DLL" (ByVal s As Integer, _
    buf As Any, _
    ByVal buflen As Integer, _
    ByVal flags As Integer, _
    to_addr As sockaddr, _
    ByVal tolen As Integer) As Integer
Public Declare Function setsockopt Lib "ws2_32.DLL" (ByVal s As Integer, _
    ByVal level As Integer, _
    ByVal optname As Integer, _
    optval As Any, _
...
Public Declare Function Socket Lib "ws2_32.DLL" Alias "socket" (ByVal af As Integer, _
...
Public Declare Function WSAAsyncGetServByName Lib "ws2_32.DLL" (ByVal hWnd As Integer, _
    ByVal wMsg As Integer, _
    ByVal serv_name As String, _
    ByVal proto As String, _
    buf As Any, _
    ByVal buflen As Integer) As Integer
Public Declare Function WSAAsyncGetServByPort Lib "ws2_32.DLL" (ByVal hWnd As Integer, _
    ByVal wMsg As Integer, _
    ByVal Port As Integer, _
    ByVal proto As String, _
    buf As Any, _
    ByVal buflen As Integer) As Integer
Public Declare Function WSAAsyncGetProtoByName Lib "ws2_32.DLL" (ByVal hWnd As Integer, _
    ByVal wMsg As Integer, _
    ByVal proto_name As String, _
    buf As Any, _
    ByVal buflen As Integer) As Integer
Public Declare Function WSAAsyncGetProtoByNumber Lib "ws2_32.DLL" (ByVal hWnd As Integer, _
    ByVal wMsg As Integer, _
    ByVal Number As Integer, _
    buf As Any, _
    ByVal buflen As Integer) As Integer
Public Declare Function WSAAsyncGetHostByName Lib "ws2_32.DLL" (ByVal hWnd As Integer, _
    ByVal wMsg As Integer, _
    ByVal host_name As String, _
    buf As Any, _
    ByVal buflen As Integer) As Integer
Public Declare Function WSAAsyncGetHostByAddr Lib "ws2_32.DLL" (ByVal hWnd As Integer, _
    ByVal wMsg As Integer, _
    addr As Long, _
...
Public Declare Function WSAAsyncSelect Lib "ws2_32.DLL" (ByVal s As Integer, _
...
'Agregado por Maraxus
Declare Function WSAAccept Lib "ws2_32.DLL" (ByVal s As Integer, _
...
Public Declare Function getsockopt Lib "wsock32.dll" (ByVal s As Long, _
...
Public Declare Function recvfrom Lib "wsock32.dll" (ByVal s As Long, _
    buf As Any, _
    ByVal buflen As Long, _
    ByVal flags As Long, _
    from As sockaddr, _
    fromlen As Long) As Long
Public Declare Function ws_select Lib "wsock32.dll" Alias "select" (ByVal nfds As Long, _
    readfds As fd_set, _
...
Public Declare Function sendto Lib "wsock32.dll" (ByVal s As Long, _
    buf As Any, _
    ByVal buflen As Long, _
    ByVal flags As Long, _
    to_addr As sockaddr, _
    ByVal tolen As Long) As Long
Public Declare Function setsockopt Lib "wsock32.dll" (ByVal s As Long, _
    ByVal level As Long, _
    ByVal optname As Long, _
    optval As Any, _
...
Public Declare Function WSAAsyncGetServByName Lib "wsock32.dll" (ByVal hWnd As Long, _
    ByVal wMsg As Long, _
    ByVal serv_name As String, _
    ByVal proto As String, _
    buf As Any, _
    ByVal buflen As Long) As Long
Public Declare Function WSAAsyncGetServByPort Lib "wsock32.dll" (ByVal hWnd As Long, _
    ByVal wMsg As Long, _
    ByVal Port As Long, _
    ByVal proto As String, _
    buf As Any, _
    ByVal buflen As Long) As Long
Public Declare Function WSAAsyncGetProtoByName Lib "wsock32.dll" (ByVal hWnd As Long, _
    ByVal wMsg As Long, _
    ByVal proto_name As String, _
    buf As Any, _
    ByVal buflen As Long) As Long
Public Declare Function WSAAsyncGetProtoByNumber Lib "wsock32.dll" (ByVal hWnd As Long, _
    ByVal wMsg As Long, _
    ByVal Number As Long, _
    buf As Any, _
    ByVal buflen As Long) As Long
Public Declare Function WSAAsyncGetHostByName Lib "wsock32.dll" (ByVal hWnd As Long, _
    ByVal wMsg As Long, _
    ByVal host_name As String, _
    buf As Any, _
    ByVal buflen As Long) As Long
Public Declare Function WSAAsyncGetHostByAddr Lib "wsock32.dll" (ByVal hWnd As Long, _
    ByVal wMsg As Long, _
    addr As Long, _
...
'Agregado por Maraxus
Declare Function WSAAccept Lib "ws2_32.DLL" (ByVal s As Long, _
    pSockAddr As sockaddr, _
    AddrLen As Long, _
    ByVal lpfnCondition As Long, _
