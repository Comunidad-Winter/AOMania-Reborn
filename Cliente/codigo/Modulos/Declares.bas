...
'Max/Min Gladiador
Public GLCONST21MAXVIDA            As Byte
Public GLCONST21MINVIDA            As Byte
Public GLCONST20MAXVIDA            As Byte
Public GLCONST20MINVIDA            As Byte
Public GLCONST19MAXVIDA            As Byte
Public GLCONST19MINVIDA            As Byte
Public GLCONST18MAXVIDA            As Byte
Public GLCONST18MINVIDA            As Byte
Public GLCONST17MAXVIDA            As Byte
Public GLCONST17MINVIDA            As Byte
Public GLCONSTOTROMAXVIDA          As Byte
Public GLCONSTOTROMINVIDA          As Byte
