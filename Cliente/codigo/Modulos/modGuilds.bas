...
Public Function PuedeFundarUnClan(ByVal UserIndex As Integer, ByRef refError As String) As Boolean
    ...
    If UserList(UserIndex).Stats.ELV < 30 And UserList(UserIndex).Stats.UserSkills(eSkill.Liderazgo) < 90 Then
...
Public Sub RecompensasCastillos(ByVal GuildIndex As Integer, ByVal RewardEXP As Long, ByVal RewardGold As Long)
            ...
            With UserList(UserIndex)
                ...
                If .ConnID <> -1 Then
                    ...
                    If .ConnIDValida And .flags.UserLogged Then
                        ...
                        Call SendData(SendTarget.toIndex, UserIndex, 0, "||Has ganado " & RewardEXP & " puntos de experiencia y " & RewardGold & _
                            " monedas de oro." & FONTTYPE_FIGHT)
